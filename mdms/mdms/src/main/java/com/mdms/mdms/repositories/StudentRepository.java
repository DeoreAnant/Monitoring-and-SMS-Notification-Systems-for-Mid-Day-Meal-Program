...
public interface StudentRepository extends JpaRepository<Student, String>{
    ...
    @Query(value = "SELECT * FROM student_table WHERE Student_mdm_id = :Student_mdm_id", nativeQuery = true)
    Student  findByStudent_mdm_id(@Param("Student_mdm_id") String Student_mdm_id);


    Student  findByStudentParentsEmail(String studentParentsEmail);
